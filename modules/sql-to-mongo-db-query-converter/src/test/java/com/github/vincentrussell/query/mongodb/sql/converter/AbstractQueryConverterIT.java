...
import com.github.vincentrussell.query.mongodb.sql.runner.QueryResultIterator;
import com.github.vincentrussell.query.mongodb.sql.runner.SQLQueryRunner;
...
public abstract class AbstractQueryConverterIT {
    ...
    public <T> T run(QueryConverter queryConverter) throws ParseException {
    	SQLQueryRunner runner = new SQLQueryRunner(queryConverter);
    	return runner.run(mongoDatabase);
    }
    ...
    public void likeQuery() throws ParseException, JSONException {
        ...
        SQLQueryRunner runner = new SQLQueryRunner(queryConverter);
        QueryResultIterator<Document> findIterable = runner.run(mongoDatabase);
    ...
    public void notLikeQuery() throws ParseException, JSONException {
        ...
        int count1 = Lists.newArrayList((Iterator) run(queryConverter1)).size();
        int count2 = Lists.newArrayList((Iterator) run(queryConverter2)).size();
        int count3 = Lists.newArrayList((Iterator) run(queryConverter3)).size();
    ...
    public void objectIdQuery() throws ParseException, JSONException {
        ...
        try {
            ...
            QueryResultIterator<Document> findIterable = run(queryConverter);
            List<Document> documents = Lists.newArrayList(findIterable);
    ...
    public void distinctQuery() throws ParseException {
        ...
        QueryResultIterator<String> distinctIterable = run(queryConverter);
    ...
    public void selectQuery() throws ParseException, IOException, JSONException {
        ...
        QueryResultIterator<Document> distinctIterable = run(queryConverter);
    ...
    public void deleteQuery() throws ParseException {
        ...
        try {
            ...
            long deleteCount = run(queryConverter);
    ...
    public void updateMany() throws ParseException, IOException, JSONException {
        ...
        try {
            ...
            long modifiedCount = run(queryConverter);
            ...
            JSONAssert.assertEquals("[{\n" +
                            ...
                            "\t\"key2\": \"value2\"\n" +
                            "}]",
                    toJson(Lists.newArrayList((Iterator<? extends Document>) run(new QueryConverter.Builder()
                            .sqlString("select _id, key, key2 from "+collection+" ORDER BY _id").build()))),false);
