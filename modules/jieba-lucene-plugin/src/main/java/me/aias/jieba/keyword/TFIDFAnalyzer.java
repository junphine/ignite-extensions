...
import me.aias.jieba.JiebaSegmenter.SegMode;
...
public class TFIDFAnalyzer
{
	...
	private Map<String, Double> getTF(String content) {
		...
		List<SegToken> segments= segmenter.process(content,SegMode.SEARCH);
		Map<String,Integer> freqMap = new HashMap<>();
		
		int wordSum=0;
		for(SegToken token: segments) {
