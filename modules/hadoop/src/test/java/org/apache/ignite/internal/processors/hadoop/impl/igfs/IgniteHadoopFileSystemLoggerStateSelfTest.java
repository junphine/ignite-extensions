...
public class IgniteHadoopFileSystemLoggerStateSelfTest extends IgfsCommonAbstractTest {
    ...
    private IgniteHadoopFileSystem fileSystem() throws Exception {
        ...
        fsCfg.addResource(U.resolveIgniteUrl("hadoop/src/test/config/hadoop/core-site-loopback.xml"));
        ...
        return (IgniteHadoopFileSystem)FileSystem.get(new URI("igfs://igfs@127.0.0.1/"), fsCfg);
    }
