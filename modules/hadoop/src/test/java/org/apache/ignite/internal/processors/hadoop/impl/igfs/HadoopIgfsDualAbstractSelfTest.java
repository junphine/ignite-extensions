...
public abstract class HadoopIgfsDualAbstractSelfTest extends IgfsCommonAbstractTest {
    ...
    protected static final String SECONDARY_URI = "igfs://igfs-secondary@127.0.0.1:11499/";

    /** Secondary file system configuration path. */
    protected static final String SECONDARY_CFG = "hadoop/src/test/config/hadoop/core-site-loopback-secondary.xml";

    /** Primary file system URI. */
    protected static final String PRIMARY_URI = "igfs://igfs@127.0.0.1/";

    /** Primary file system configuration path. */
    protected static final String PRIMARY_CFG = "hadoop/src/test/config/hadoop/core-site-loopback.xml";
    ...
    static {
        ...
        SECONDARY_REST_CFG.setPort(11499);
    }
