...
public class HadoopIgfsOutProc implements HadoopIgfsEx, HadoopIgfsIpcIoListener {
     ...
     */
    public HadoopIgfsOutProc(String host, int port, String igfs, Logger log, String user) throws IOException {
     ...
     * @throws IOException If failed.
     */
    public HadoopIgfsOutProc(int port, String igfs, Logger log, String user) throws IOException {
     ...
     * @throws IOException If failed.
     */
    private HadoopIgfsOutProc(String host, int port, String igfs, boolean shmem, Logger log, String user)
        throws IOException {
