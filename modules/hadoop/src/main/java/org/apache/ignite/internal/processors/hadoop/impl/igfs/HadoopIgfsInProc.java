...
public class HadoopIgfsInProc implements HadoopIgfsEx {
     ...
     */
    private HadoopIgfsInProc(IgfsEx igfs, Logger log, String userName) {
        this.igfs = igfs;
     ...
     */
    public static HadoopIgfsInProc create(String igfsName, Logger log, String userName) {
     ...
     */
    public static HadoopIgfsInProc create(String igniteCfgPath, String igfsName, Logger log, String userName)
     ...
     */
    private static HadoopIgfsInProc create0(Ignite ignite, String igfsName, Logger log, String userName) {
        ...
        if (Ignition.state(ignite.name()) == STARTED) {
            try {
                for (IgniteFileSystem fs : ignite.fileSystems()) {
                    if (Objects.equals(fs.name(), igfsName)) {
