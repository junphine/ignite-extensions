...
public class HadoopIgfsWrapper implements HadoopIgfs {
     ...
     */
    public HadoopIgfsWrapper(String authority, String logDir, Configuration conf, Logger log, String user)
        throws IOException {
        try {
    ...
    private Delegate delegate() throws HadoopIgfsCommunicationException {
        ...
        if (curDelegate == null && !skipRmtTcp && (skipLocTcp || !Objects.equals(LOCALHOST, endpoint.host()))) {
            HadoopIgfsEx hadoop = null;
